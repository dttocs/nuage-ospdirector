...
#
# [*nuage_fip_underlay*]
#   (optional) Flag to enable Floating IP underlay.
#   The default is false
#
# [*nuage_pat*]
#   (optional) Flag to enable Port Address Translation.
#   The default is default_enabled
#
# [*nuage_auth_resource*]
...
class neutron::plugins::nuage (
  ...
  neutron_plugin_nuage {
    ...
    'RESTPROXY/nuage_fip_underlay':         value => $nuage_fip_underlay;
    'RESTPROXY/nuage_pat':                  value => $nuage_pat;
  }
